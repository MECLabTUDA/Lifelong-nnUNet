...
trainer.output_folder = os.path.join(trainer_path_base, path_up_to_16, path_end)
...
trainer.reinitialize("Task313_BraTS13")
trainer.load_plans_file()
trainer.load_dataset()
trainer.do_split()
trainer.store_features("Task313_BraTS13")
trainer.store_features("Task313_BraTS13", False)
