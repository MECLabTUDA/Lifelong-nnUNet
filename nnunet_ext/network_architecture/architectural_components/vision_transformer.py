...
from nnunet_ext.network_architecture.architectural_components.encoders import Encoder, PositionalEncoding
...
class VisionTransformer(VisionTransformer2D):
    ...
    def __init__(self, ViT_2d: bool, img_size=224, patch_size=16, img_depth=None, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        r"""This function represents the constructor of ViT. The user has to specify if a 2D ViT (from timm module)
            ...
            Set pos_embed to 'pos_encode' to use a PositionalEncoding instead of a simple nn.Parameter.
        """
        ...
        for idx, patch_e in enumerate(self.patch_embeds):
            ...
            if pos_embed == 'pos_encode':
                setattr(self, 'pos_embed_'+str(idx), PositionalEncoding())
            else:
...
# https://github.com/avishkarsaha/translating-images-into-maps/blob/92b9627bef43e9a50f136c13a438a02be9ceebb2/src/model/transformer.py#L163
