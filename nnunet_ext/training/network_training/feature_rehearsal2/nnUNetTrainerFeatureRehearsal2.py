...
class nnUNetTrainerFeatureRehearsal2(nnUNetTrainerMultiHead):
    ...
    def store_features(self, task):
        ...
        with torch.no_grad():
            ...
            dataloader = FeatureRehearsalDataLoader(dataset, batch_size=int(self.batch_size), num_workers=8, pin_memory=True, 
                                                    deep_supervision_scales=self.deep_supervision_scales, deterministic=self.deterministic)
