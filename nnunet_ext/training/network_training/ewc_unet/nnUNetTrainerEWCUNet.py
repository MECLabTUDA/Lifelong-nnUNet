...
class nnUNetTrainerEWCUNet(nnUNetTrainerEWC):
    def __init__(self, split, task, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        r"""Constructor of EWC UNet Trainer for 2D, 3D low resolution and 3D full resolution nnU-Nets.
        """
        ...
        self.ewc_data_path = join(self.trained_on_path, 'ewc_data_unet')
    ...
    def initialize(self, training=True, force_load_plans=False, num_epochs=500, prev_trainer_path=None, call_for_eval=False):
        ...
        self.loss = EWCLoss(self.loss, self.ds_loss_weights,
                            ...
                            True, ['ViT'], False) # --> match everything except 'ViT', ie. EWC on UNet
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False, detach=True, no_loss=False):
        ...
        if not no_loss:
            ...
            parameters = [(name, param) for name, param in self.network.named_parameters() if 'ViT' not in name]
