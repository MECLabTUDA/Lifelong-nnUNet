...
class Experiment():
    ...
    def __init__(self, network, network_trainer, tasks_list_with_char, version=1, vit_type='base', fold=0,
                 ...
                 use_all_data=False, filter_rate=0.35, filter_with='high_basic', nth_filter=10, useFFT=False, f_map_type=None, conv_smooth=None, ts_msa=False,
        ...
        self.basic_exts = {'save_interval': self.save_interval, 'identifier': self.plans_identifier, 'extension': self.extension,
                           ...
                           'conv_smooth': conv_smooth, 'ts_msa': self.ts_msa, 'cross_attn': cross_attn, 'cbam': self.cbam, **basic_args}
        ...
        self.basic_eval_args = {'network': self.network, 'network_trainer': self.network_trainer, 'tasks_list_with_char': self.tasks_list_with_char,
                                ...
                                'f_map_type': f_map_type, 'conv_smotth': conv_smooth, 'ts_msa': self.ts_msa, 'cross_attn': cross_attn, 'cbam': self.cbam}
