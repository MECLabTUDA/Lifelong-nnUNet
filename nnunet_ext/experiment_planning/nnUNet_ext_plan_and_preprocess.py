...
def main():
    ...
    search_in_ext = join(nnunet_ext.__path__[0], "experiment_planning")
    ...
    if planner_name3d is not None:
        ...
        if planner_3d is None:
            planner_3d = recursive_find_python_class([search_in_ext], planner_name3d, current_module="nnunet_ext.experiment_planning")
        if planner_3d is None:
    ...
    if planner_name2d is not None:
        ...
        if planner_2d is None:
            planner_2d = recursive_find_python_class([search_in_ext], planner_name2d, current_module="nnunet_ext.experiment_planning")
        if planner_2d is None:
            raise RuntimeError("Could not find the Planner class %s. Make sure it is located somewhere in "
