...
class ParamSearcher():
    ...
    def __init__(self, network, network_trainer, tasks_list_with_char, version=1, vit_type='base', fold=0,
                 ...
                 filter_rate=0.35, filter_with='high_basic', nth_filter=10, useFFT=False, f_map_type=None, conv_smooth=None, ts_msa=False,
        ...
        self.exp_args = {'network': network, 'network_trainer': network_trainer, 'tasks_list_with_char': tasks_list_with_char,
                         'version': version, 'vit_type': vit_type, 'fold': fold, 'plans_identifier': plans_identifier, 'useFFT': useFFT,
                         ...
                         'ts_msa': self.ts_msa, 'cross_attn': cross_attn, 'cbam': cbam}
