...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(nnunet_ext.__path__[0], "nnunet", "training", "network_training"),
                              base_module='nnunet_ext.nnunet.training.network_training'):
    assert network in ['2d', '3d_lowres', '3d_fullres', '3d_cascade_fullres', 'alt_network'], \
