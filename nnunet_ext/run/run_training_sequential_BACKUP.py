...
def main():
    ...
    if init_seq:
        ...
        assert prev_trainer is not None, "When using the first provided task as a base for training with an extension, the network_trainer needs to be specified as well."
    ...
    for t_fold in fold:
        ...
        if continue_training:
            ...
            already_trained_on = load_json(join(network_training_output_dir, network, tasks_joined_name, "trained_on.json"))
