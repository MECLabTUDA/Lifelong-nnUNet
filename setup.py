...
setup(name='nnunet_ext',
      ...
      entry_points={
          'console_scripts': [
              ...
              'vit_nnunet_train = nnunet_ext.run.run_training_vit:main',                       # Use for training with Generic_ViT_UNet
              ...
              'nnUNet_train_freezed_nonln = nnunet_ext.run.run_training:main_freezed_nonln',   # Use for freezing all layers except LN
              'nnUNet_train_freezed_unet = nnunet_ext.run.run_training:main_freezed_unet',     # Use for freezing all nnUNet layers
              'nnUNet_train_freezed_vit = nnunet_ext.run.run_training:main_freezed_vit',       # Use for freezing all ViT layers
