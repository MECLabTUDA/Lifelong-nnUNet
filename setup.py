...
setup(name='nnunet_ext',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNet_delete_tasks = nnunet_ext.scripts.delete_specified_task:main'                      # Use for deleting preprocessed and planned data
          ],
      },
      keywords=['deep learning', 'image segmentation', 'medical image analysis',
                'medical image segmentation', 'nnU-Net', 'nnUNet', 'nnunet', 'CL', 'Continual Learning',
